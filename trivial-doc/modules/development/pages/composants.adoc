...
Serveur --> C2 : bleu
C2 -> Serveur: RepondreQuestion("T")
Serveur --> C2 : true
C2 -> Serveur: AjoutTriangle()
Serveur --> C2 : true
C2 -> Serveur: TrourJoueur("EKLO1")
Serveur --> C2 : true

C1-> Serveur: TrourJoueur("BARRY1")
Serveur --> C1 : false

C3 -> Serveur: TrourJoueur("YAYA1")
Serveur --> C3 : false
